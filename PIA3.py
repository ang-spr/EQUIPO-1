    ...
    try:
        with sqlite3.connect('EVIDENCIA_3_TALLER_MECANICO.db') as conn:
            ...
            if not clientes_suspendidos:
                aviso("No hay clientes suspendidos que recuperar.", 15)
                indicarEnter()
                return
            else:
                ...
                print('\nIngrese la clave del cliente a recuperara o 0 para volver al menú anterior.')
            while True:
        ...
        with sqlite3.connect('EVIDENCIA_3_TALLER_MECANICO.db') as conn:
            ...
            if registros:
                ...
                mi_cursor.execute("""
                    ...
                    FROM NOTAS 
                    WHERE FECHA BETWEEN ? AND ? """,(fecha_inicial,fecha_fin))
                monto_promedio = mi_cursor.fetchone()[0]
                print(guiones(80))
                print(f'El monto promedio de las notas en ese periodo es: {monto_promedio:.2f}')
                print(guiones(80))
